...
class VerticalScrollViewController: UIViewController, UIScrollViewDelegate {
    ...
    func setupScrollView() {
        ...
        topVc.view.frame = CGRectMake(0, 0, CGRectGetWidth(self.view.bounds), CGRectGetHeight(self.view.bounds) - 50)
...
extension VerticalScrollViewController: LayoutViewControllerDelegate {
